...
func (*LookupRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func (*LookupResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*MkDirRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func (*MkDirResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*ReadDirAllRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
func (*ReadDirAllResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }
...
func (*DirEnt) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }
...
func (*ReadRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }
...
func (*ReadResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
func (*RemoveRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }
...
func (*RemoveResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func (*RemovexattrRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*RemovexattrResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*RenameRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*RenameResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (*SetAttrRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func (*SetAttrResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (*SetxattrRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{34} }
...
func (*SetxattrResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }
...
func (*SymlinkRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }
...
func (*SymlinkResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{39} }
...
func (*WriteRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{40} }
...
func (*WriteResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41} }
...
func (c *formicClient) Listxattr(ctx context.Context, opts ...grpc.CallOption) (Formic_ListxattrClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[6], c.cc, "/newproto.Formic/Listxattr", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Lookup(ctx context.Context, opts ...grpc.CallOption) (Formic_LookupClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[7], c.cc, "/newproto.Formic/Lookup", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) MkDir(ctx context.Context, opts ...grpc.CallOption) (Formic_MkDirClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[8], c.cc, "/newproto.Formic/MkDir", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) ReadDirAll(ctx context.Context, opts ...grpc.CallOption) (Formic_ReadDirAllClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[9], c.cc, "/newproto.Formic/ReadDirAll", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Readlink(ctx context.Context, opts ...grpc.CallOption) (Formic_ReadlinkClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[10], c.cc, "/newproto.Formic/Readlink", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Read(ctx context.Context, opts ...grpc.CallOption) (Formic_ReadClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[11], c.cc, "/newproto.Formic/Read", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Remove(ctx context.Context, opts ...grpc.CallOption) (Formic_RemoveClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[12], c.cc, "/newproto.Formic/Remove", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Removexattr(ctx context.Context, opts ...grpc.CallOption) (Formic_RemovexattrClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[13], c.cc, "/newproto.Formic/Removexattr", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Rename(ctx context.Context, opts ...grpc.CallOption) (Formic_RenameClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[14], c.cc, "/newproto.Formic/Rename", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) SetAttr(ctx context.Context, opts ...grpc.CallOption) (Formic_SetAttrClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[15], c.cc, "/newproto.Formic/SetAttr", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Setxattr(ctx context.Context, opts ...grpc.CallOption) (Formic_SetxattrClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[16], c.cc, "/newproto.Formic/Setxattr", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Statfs(ctx context.Context, opts ...grpc.CallOption) (Formic_StatfsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[17], c.cc, "/newproto.Formic/Statfs", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Symlink(ctx context.Context, opts ...grpc.CallOption) (Formic_SymlinkClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[18], c.cc, "/newproto.Formic/Symlink", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Write(ctx context.Context, opts ...grpc.CallOption) (Formic_WriteClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[19], c.cc, "/newproto.Formic/Write", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	,
}
