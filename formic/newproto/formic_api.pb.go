...
func (*SetAttrRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*SetAttrResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*WriteRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*WriteResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (c *formicClient) Remove(ctx context.Context, opts ...grpc.CallOption) (Formic_RemoveClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[4], c.cc, "/newproto.Formic/Remove", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) SetAttr(ctx context.Context, opts ...grpc.CallOption) (Formic_SetAttrClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[5], c.cc, "/newproto.Formic/SetAttr", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Write(ctx context.Context, opts ...grpc.CallOption) (Formic_WriteClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[6], c.cc, "/newproto.Formic/Write", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	,
}
