...
func (*StatfsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }
...
func (*StatfsResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{39} }
...
func (*SymlinkRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{40} }
...
func (*SymlinkResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41} }
...
func (*WriteRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{42} }
...
func (*WriteResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{43} }
...
func (c *formicClient) Statfs(ctx context.Context, opts ...grpc.CallOption) (Formic_StatfsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[18], c.cc, "/newproto.Formic/Statfs", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Symlink(ctx context.Context, opts ...grpc.CallOption) (Formic_SymlinkClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[19], c.cc, "/newproto.Formic/Symlink", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Write(ctx context.Context, opts ...grpc.CallOption) (Formic_WriteClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[20], c.cc, "/newproto.Formic/Write", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	,
}
