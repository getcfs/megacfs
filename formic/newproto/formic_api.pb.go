...
func (*SymlinkRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*SymlinkResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (*WriteResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (c *formicClient) Symlink(ctx context.Context, opts ...grpc.CallOption) (Formic_SymlinkClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[14], c.cc, "/newproto.Formic/Symlink", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *formicClient) Write(ctx context.Context, opts ...grpc.CallOption) (Formic_WriteClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Formic_serviceDesc.Streams[15], c.cc, "/newproto.Formic/Write", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	,
}
